...
{			
  ...
  z = width/1.41 - width/2;
  z = z/1.42;
  drawRect(0,0, z, z, buttonColor['Save']);
  drawText(z/2-25, z/2, "Save", blackFill);
  
  drawRect(width-z,height-z, z, z, buttonColor['Roll']);
  ...
  if(die1 == 2 || die1 == 3 || die1 == 4 || die1 == 5 || die1 == 6)
    drawCircle(new Vector(z/8, height-3*z/5), 5, blackFill);  //top left
  if(die1 == 4 || die1 == 5 || die1 == 6)
  ...
  if(die2 == 2 || die2 == 3 || die2 == 4 || die2 == 5 || die2 == 6)
    drawCircle(new Vector(z/2+z/8, height-3*z/5), 5, blackFill);
  if(die2 == 4 || die2 == 5|| die2 == 6)
